...
namespace UKTakeHomeCalc.Core.Test.CalculatorTests
{
    public class CalculatorTests
    {
        ...
        private Mock<ISalaryItemNode> _calculatorNode;
        ...
        public CalculatorTests()
        {
            ...
            _calculatorNode = new Mock<ISalaryItemNode>();
            ...
            _calculationStrategyMock1.Setup(x => x.CreateSalaryItem(It.IsAny<ISalaryItemNode>()))
                .Returns(new SalaryItem("salaryItem test 1", 550.0m.Weekly()));
            _calculationStrategyMock2.Setup(x => x.CreateSalaryItem(It.IsAny<ISalaryItemNode>()))
                .Returns(new SalaryItem("salaryItem test 2", 905.0m.Weekly()));
            _calculationStrategyMock3.Setup(x => x.CreateSalaryItem(It.IsAny<ISalaryItemNode>()))
                .Returns(new SalaryItem("salaryItem test 3", 10.0m.Weekly()));
        ...
        public void CreateSalaryItemNode_ShouldRetrieveSalaryItemFromCalculationStrategy()
        {
            ...
            _calculationStrategyMock1.Verify(x => x.CreateSalaryItem(It.IsAny<ISalaryItemNode>()), Times.Exactly(1));
            _calculationStrategyMock2.Verify(x => x.CreateSalaryItem(It.IsAny<ISalaryItemNode>()), Times.Exactly(1));
            _calculationStrategyMock3.Verify(x => x.CreateSalaryItem(It.IsAny<ISalaryItemNode>()), Times.Exactly(1));
        }
        [Fact]
        public void CreateSalaryItemNode_ShouldAddSalaryItemsToItsCalculatorNode()
        {
            ...
            _calculatorNode.Verify(x => x.AddValue(It.IsAny<ISalaryItem>()), Times.Exactly(3));
        }
        [Fact]
